...
/**
 * @brief Convertit un type de pièce en sa représentation ASCII pour les pièces
 * blanches.
 *
 ...
 *
 * Cette fonction prend une chaîne représentant le type de pièce (par exemple
 * "King", "Queen", etc.) et retourne l'énumération correspondante `PieceKind`.
 *
 ...
 * @warning Termine le programme avec `exit(EXIT_FAILURE)` si la chaîne n'est
 * pas reconnue.
 */
